...
export const WebViewContext = createContext<{witnessCalculationWebView: Function}>({witnessCalculationWebView: ()=>({})});
...
export const WebViewWrapperProvider = (props: any) => {
    ...
    const witnessCalculationWebView = async (binary: Uint8Array, inputs: any): Promise<Uint8Array> => {
        // @ts-ignore
